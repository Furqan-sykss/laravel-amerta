...
<style>
  ...
  .site-footer .footer-cta h2, .site-footer .footer-cta .h2 {
    ...
    <div class="container">
            ...
            <div class="col-lg-4 ">
                ...
                <div class="widget">
                    <h3>Social</h3>
                        ...
                        <a class="" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
        ...
        <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script>. Amerta. &mdash; Create with love by  <a class="text-white" href="https://untree.co"> Furqan</a>  
        </p>
      </div>
    </div>
  </div> <!-- /.container -->
