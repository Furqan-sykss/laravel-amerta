    ...
    <div class="row">
            <div class="col-lg-12 mt-2 text-center">
                <h1>Filsafat Romawi penawar Depresi</h1>
                            <br>
                            <h4>Stoisisme didasarkan pada ide bahwa tujuan hidup adalah hidup selaras dengan alam.
                            </h4>
                            <br>
                            <div class="">
...
<div class="container-lg mt-5">
    <div class="row">
        <div class="col-lg-10">
            ...
            <div class="clearfix">
                <img src="img/marcus.jpg" height="400px" class="col-md-4 float-md-end mb-3 ms-md-3" alt="...">
                <p>
