    ...
    <div class="row">
            <div class="col-lg-12 mt-2 text-center">
                <h1>Filosofi Kehidupan ala Albert Camus: Hidup Itu Absurd!</h1>
                            <br>
                            <h4 class="text-secondary">landasan seseorang setiap melakukan sesuatu dalam hidupnya.
                            </h4>
                            <br>
                            <div class="">
    ...
    <div class="row">
        <div class="col-lg-10">
            <p>Pada titik-titik tertentu dalam hidup, gak jarang orang-orang bakal merenung atau setidaknya bertanya-tanya untuk apa sih sebenarnya kita hidup selama ini. Dan hal itu buat kita jadi semakin bingung tentang filosofi kehidupan dan tujuan hidup kita sendiri.</p>
                ...
                <div class="clearfix">
                    <img src="img/camus.jpg" height="300px" class="col-md-4 float-md-end mb-3 ms-md-3" alt="...">
                    <p>
                ...
                <div class="clearfix">
                    ...
                    <img class="col-md-4 float-md-end mb-3 ms-md-3" src="img/meme.jpg" height="300px" alt="">
        ...
        <div class="col-11 col-lg-12">
            <div class="row featurette mb-3 border rounded overflow-hidden shadow-sm h-md-250 position-relative">
                <div class="col-md-7 mt-2">
                    <h2 class="featurette-heading fw-normal lh-1">Filosofi Hidup Alain de Botton: Hidup Biasa Aja itu Lebih Bahagia! </h2>
                    <p class="lead" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">Alain de Botton berhasil menemukan solusi atas keresahan yang kita semua rasakan.</p>
                    <a href="/articlefilsafat.enam" class="stretched-link"></a>
                </div>
                <div class="col-md-5 mt-2 mb-3">
                    <img src="img/29969-alain.jpg" width="500" height="500" class="img-thumbnail" alt="...">
                    </svg>
                </div>
            </div>
        </div>
