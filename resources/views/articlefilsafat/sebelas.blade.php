...
<div class="container-lg">
    <div class="row">
            <div class="col-lg-12 mt-2 text-center">
                <h1>Al-Kindi Jembatan Filsafat Yunani dan Islam
                </h1>
                            <br>
                            <h4 class="text-secondary">Al-Kindi hidup sebagai cendekiawan brilian abad kesembilan di masa Abbasiyah.
                            </h4>
                            <br>
                            <div class="">
                                <img class="" src="img/36897-kindi.jpg" alt="">
                            </div>
            </div>
</div>
        ...
        <div class="col-11 col-lg-12">
            <div class="row featurette mb-3 border rounded overflow-hidden shadow-sm h-md-250 position-relative">
                <div class="col-md-7 mt-2">
                    <h2 class="featurette-heading fw-normal lh-1">Filosofi Kehidupan ala Albert Camus: Hidup Itu Absurd!</h2>
                    <p class="lead" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">Landasan seseorang setiap melakukan sesuatu dalam hidupnya..</p>
                    <a href="/articlefilsafat.lima" class="stretched-link"></a>
                </div>
                <div class="col-md-5 mt-2 mb-3">
                    <img src="img/albert1234.jpg" width="500" height="500" class="img-thumbnail" alt="...">
                    </svg>
                </div>
            </div>
        </div>
