        ...
        <div class="col-11 col-lg-12">
            <div class="row featurette mb-3 border rounded overflow-hidden shadow-sm h-md-250 position-relative">
                <div class="col-md-7 mt-2">
                    <h2 class="featurette-heading fw-normal lh-1">Makna Dalam Setiap Peristiwa </h2>
                    <p class="lead" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">Dalam Konsep Takdir , Agama memberi ruang akan hal ini.</p>
                    <a href="/articlefilsafat.delapan" class="stretched-link"></a>
                </div>
                <div class="col-md-5 mt-2 mb-3">
                    <img src="img/55883-mkna1.jpg" width="500" height="500" class="img-thumbnail" alt="...">
                    </svg>
                </div>
            </div>
        </div>
