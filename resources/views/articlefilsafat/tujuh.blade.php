...
<div class="container-lg">
    <div class="row">
            <div class="col-lg-12 mt-2 text-center">
                <h1>Filosofi Kehidupan Epicurus: Kunci Hidup Bahagia Meski Hidup Sederhana</h1>
                            <br>
                            <h4 class="text-secondary">Apakah kamu sudah merasa cukup bahagia dengan hidupmu saat ini?
                            </h4>
                            <br>
                            <div class="">
                                <img class="" src="img/17374-epicurus.jpg" alt=""width="80%" height="100%">
                            </div>
            </div>
</div>
    ...
    <div class="row">
        <div class="col-lg-10">
            ...
            <div class="clearfix">
                ...
                <img src="img/epicurus2.jpg" height="280px" class="col-md-3 float-md-end mb-3 ms-md-3" alt="...">
                <p>
                    <strong>
        ...
        <div class="col-11 col-lg-12">
            <div class="row featurette mb-3 border rounded overflow-hidden shadow-sm h-md-250 position-relative">
                <div class="col-md-7 mt-2">
                    <h2 class="featurette-heading fw-normal lh-1">Seneca dan Kebebasan Batin</h2>
                    <p class="lead" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">Hidup adalah perjalanan yang penuh dengan bunga dan duri. Ini tidak dapat disangkal.</p>
                    <a href="/articlefilsafat.sepuluh" class="stretched-link"></a>
                </div>
                <div class="col-md-5 mt-2 mb-3">
                    <img src="img/26373-seneca.jpg" width="500" height="500" class="img-thumbnail" alt="...">
                    </svg>
                </div>
            </div>
        </div>
