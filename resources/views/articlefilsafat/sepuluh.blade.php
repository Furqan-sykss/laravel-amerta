...
<div class="container-lg">
    <div class="row">
            <div class="col-lg-12 mt-2 text-center">
                <h1>Seneca dan Kebebasan Batin
                </h1>
                            <br>
                            <h4 class="text-secondary">Hidup adalah perjalanan yang penuh dengan bunga dan duri. Ini tidak dapat disangkal.
                            </h4>
                            <br>
                            <div class="">
                                <img class="" src="img/26373-seneca.jpg" alt="">
                            </div>
            </div>
</div>
        ...
        <div class="col-11 col-lg-12">
            <div class="row featurette mb-3 border rounded overflow-hidden shadow-sm h-md-250 position-relative">
                <div class="col-md-7 mt-2">
                    <h2 class="featurette-heading fw-normal lh-1">Belajar dari Epictetus agar Tak Menderita Terus</h2>
                    <p class="lead" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">Beberapa hal tergantung pada sikap kita, selebihnya tidak ~ Epictetus.</p>
                    <a href="/articlefilsafat.sembilan" class="stretched-link"></a>
                </div>
                <div class="col-md-5 mt-2 mb-3">
                    <img src="img/epicurus888.jpg" width="500" height="500" class="img-thumbnail" alt="...">
                    </svg>
                </div>
            </div>
        </div>
