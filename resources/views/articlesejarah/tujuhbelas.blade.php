...
<div class="container-lg">
    <div class="row">
            <div class="col-lg-12 mt-2 text-center">
                ...
                <br>
                <h4>Kejatuhan Konstantinopel adalah suatu peristiwa penyerbuan ke ibukota Kekaisaran Byzantine oleh tentara Ottoman pada 29 Mei 1453.</h4>
                <br>
                <div class="">
                    <img class="" src="img/88442-kons1.jpg" alt="" width="80%" height="100%">
                </div>
            </div>
    </div>
        ...
        <div class="col-11 col-lg-12">
            <div class="row featurette mb-3 border rounded overflow-hidden shadow-sm h-md-250 position-relative">
                <div class="col-md-7 mt-2">
                    <h2 class="featurette-heading fw-normal lh-1">Kemenangan dan Kegagalan di Aceh. </h2>
                    <p class="lead" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">Datang untuk membantu pemerintah menghadapi perlawanan Aceh. Berhasil di awal, tapi gagal di akhir.</p>
                    <a href="/articlesejarah.tigaa" class="stretched-link"></a>
                </div>
                <div class="col-md-5 mt-2 mb-3">
                    <img src="img/article1.png" width="500" height="500" class="img-thumbnail" alt="...">
                    </svg>
