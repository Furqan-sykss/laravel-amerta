...
<div class="container-lg" style="color: #214252">
    <div class="row">
            <div class="col-lg-12 mt-2 text-center">
                <h1>Perintah pertama Soekarno sebagai Presiden RI.</h1>
                <br>
                <h4> Sehari setelah kemerdekaan Republik Indonesia pada 17 Agustus 1945</h4>
                <br>
                <div class="">
                    <img class="" src="img/17047-sukarno1.jpg" alt="" width="80%" height="100%">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-11 col-lg-12">
            <div class="row featurette mb-3 border rounded overflow-hidden shadow-sm h-md-250 position-relative">
                <div class="col-md-7 mt-2">
                    <h2 class="featurette-heading fw-normal lh-1">Masa-masa Penghabisan </h2>
                    <p class="lead" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">Snouck Hurgronje menimba ilmu hingga masa tuanya. Dimakamkan di kuburan Kristen.</p>
                    <a href="/articlesejarah.satu" class="stretched-link"></a>
                </div>
                <div class="col-md-5 mt-2 mb-3">
                    <img src="img/48163-article2.png" class="img-thumbnail" alt="...">
                    </svg>
                </div>
            </div>
        </div>
