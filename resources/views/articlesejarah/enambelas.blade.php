...
<div class="container-lg" style="color: #214252">
    <div class="row">
            <div class="col-lg-12 mt-2 text-center">
                ...
                <br>
                <h4>Pemberontakan Teuku Daud Beureueuh dan Rakyat Aceh</h4>
                <br>
                <div class="">
                    <img class="" src="img/61143-teukudaud.jpg" alt="" width="60%" height="100%">
                </div>
            </div>
    </div>
</div>
    <div class="container-lg mt-5">
        ...
        <center>
            <figure>
                <img src="img/acehditii.jpg" style="width:500px;height:333px;">
                <figcaption>
        ...
        <div class="col-11 col-lg-12">
            <div class="row featurette mb-3 border rounded overflow-hidden shadow-sm h-md-250 position-relative">
                <div class="col-md-7 mt-2">
                    <h2 class="featurette-heading fw-normal lh-1">Sejarah Pendidikan di Indonesia. </h2>
                    <p class="lead" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">Pengetahuan adalah kekuatan yang membedakan dan menjadi kelebihan bagi manusia.</p>
                    <a href="articlesejarah.empatbelas" class="stretched-link"></a>
                </div>
                <div class="col-md-5 mt-2 mb-3">
                    <img src="img/82461-belajar1.jpg" width="500" height="500" class="img-thumbnail" alt="...">
                    </svg>
