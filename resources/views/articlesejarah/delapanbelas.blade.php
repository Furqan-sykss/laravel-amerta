...
<div class="container-lg" style="color: #214252">
    <div class="row">
            <div class="col-lg-12 mt-2 text-center ">
                <h1>Perang Sipil Amerika 1861 - 1865.
                </h1>
                <br>
                <h4>Perseturuan antar saudara
                </h4>
                <br>
                <div class="">
                    <img class="" src="img/23821-sipilwar1.jpg" alt="" width="80%" height="100%">
                </div>
            </div>
        </div>
    </div>
    <div class="container-lg mt-5">
        <div class="col-10">
            ...
            <center>
                <figure>
                    <img src="img/sipilwar2.jpg" style="width:500px;height:333px;">
                    <figcaption>
