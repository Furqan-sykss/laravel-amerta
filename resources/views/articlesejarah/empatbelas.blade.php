        ...
        <div class="container-lg">
            <div class="row">
                    ...
                    <div class="col-lg-12 mt-2 text-center">
                        <h1>Sejarah Pendidikan di Indonesia.</h1>
                        <br>
                        <h4>Pengetahuan adalah kekuatan yang membedakan dan menjadi kelebihan bagi manusia.</h4>
                        <br>
                        <div class="">
                            <img class="" src="img/82461-belajar1.jpg" alt="" width="60%" height="100%">
                        </div>
                    </div>
            </div>
            <div class="col-10">
                ...
                <center>
                    <figure>
                        <img src="img/belajar2.jpg" style="width:500px;height:333px;">
                        <figcaption>
            ...
            <div class="col-11 col-lg-12">
                <div class="row featurette mb-3 border rounded overflow-hidden shadow-sm h-md-250 position-relative">
                    <div class="col-md-7 mt-2">
                        <h2 class="featurette-heading fw-normal lh-1">D.I. Pandjaitan Cari Jodoh di Tengah Perang. </h2>
                        <p class="lead" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">Niatnya mempersunting kekasih hati terbentur restu calon mertua. Mulai dari sentimen terhadap militer, perkara adat, hingga insiden asbak pecah.</p>
                        <a href="/articlesejarah.duapuluhsatu" class="stretched-link"></a>
                    </div>
                    <div class="col-md-5 mt-2 mb-3">
                        <img src="img/panjaitan.jpg" width="500" height="500" class="img-thumbnail" alt="...">
                        </svg>
