    ...
    <div class="row">
            <div class="col-lg-12 mt-2 text-center">
                <h1>Jalur rempah nusantara.</h1>
                            <br>
                            <h4>Jalur rempah adalah ruang bagi masyarakat Nusantara juga bangsa luar berinteraksi satu sama lain yang dipertemukan melalui perdagangan rempah.</h4>
                            <br>
                            <div class="">
                                <img class="" src="img/38399-rmph.jpg" alt="" width="80%" height="100%">
                            </div>
            </div>
</div>
<div class="container-lg mt-5">
    <div class="row">
        <div class="col col-lg-10">
            ...
            <center>
                <figure>
                    <img src="img/rmph2.jpg" style="width:500px;height:333px;">
                    <figcaption>
        ...
        <div class="col-11 col-lg-12">
            <div class="row featurette mb-3 border rounded overflow-hidden shadow-sm h-md-250 position-relative">
                <div class="col-md-7 mt-2">
                    <h2 class="featurette-heading fw-normal lh-1">Perang Sipil Amerika 1861 - 1865.</h2>
                    <p class="lead" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">Perseturuan antar saudara.</p>
                    <a href="/articlesejarah.delapanbelas" class="stretched-link"></a>
                </div>
                <div class="col-md-5 mt-2 mb-3">
                    <img src="img/23821-sipilwar1.jpg" class="img-thumbnail" alt="...">
                    </svg>
                </div>
            </div>
        </div>
