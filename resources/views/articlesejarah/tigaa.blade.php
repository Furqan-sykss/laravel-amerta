...
<div class="container-lg" style="color: #214252">
    <div class="row">
            <div class="col-lg-12 mt-5 ">
                ...
                <br>
                <h4 class="text-center text-secondary">Datang untuk membantu pemerintah menghadapi perlawanan Aceh. Berhasil di awal, tapi gagal di akhir.</h4>
                <br>
                <div class="text-center">
                    <img class="" src="img/article1.png" alt="" width="50%">
                </div>
            </div>
    </div>
</div>
        ...
        <div class="col-11 col-lg-12">
            <div class="row featurette mb-3 border rounded overflow-hidden shadow-sm h-md-250 position-relative">
                <div class="col-md-7 mt-2">
                    <h2 class="featurette-heading fw-normal lh-1">Perintah pertama Soekarno sebagai Presiden RI. </h2>
                    <p class="lead" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;"> Sehari setelah kemerdekaan Republik Indonesia pada 17 Agustus 1945.</p>
                    <a href="/articlesejarah.sembilan" class="stretched-link"></a>
                </div>
                <div class="col-md-5 mt-2 mb-3">
                    <img src="img/17047-sukarno1.jpg" width="500" height="500" class="img-thumbnail" alt="...">
                    </svg>
