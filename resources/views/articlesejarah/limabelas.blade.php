...
<div class="container-lg" style="color: #214252">
    <div class="row">
            <div class="col-lg-12 mt-2 text-center">
                ...
                <br>
                <h4> perjalanan dari merah putih, dimana merah putih memiliki filosofi tersendiri</h4>
                <br>
                <div class="">
                    <img class="" src="img/49150-bendera1.jpg" alt="" width="60%" height="100%">
                </div>
            </div>
    </div>
</div>
    <div class="container-lg mt-5">
        ...
        <center>
            <figure>
                <img src="img/bendera2" style="width:500px;height:333px;">
                <figcaption>
        ...
        <div class="col-11 col-lg-12">
            <div class="row featurette mb-3 border rounded overflow-hidden shadow-sm h-md-250 position-relative">
                <div class="col-md-7 mt-2">
                    <h2 class="featurette-heading fw-normal lh-1">Pemberontakan DI/TII di Aceh. </h2>
                    <p class="lead" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">Pemberontakan Teuku Daud Beureueuh dan Rakyat Aceh.</p>
                    <a href="/articlesejarah.enambelas" class="stretched-link"></a>
                </div>
                <div class="col-md-5 mt-2 mb-3">
                    <img src="img/61143-teukudaud.jpg" width="500" height="500" class="img-thumbnail" alt="...">
                    </svg>
